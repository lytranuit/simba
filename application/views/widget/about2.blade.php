...
<!--- ABOUT2 -->
<div class="section clearfix" style="padding: 60px 0 40px 0;position: relative;background: #efefef42;">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        ...
                        <p>
                            Esse sequi veniam, assumenda voluptate necessitatibus ipsa dicta vero, minima natus cum cupiditate magnam et placeat quo adipisci.
                        </p>
                        <a class="btn-get-started" href="page-about.html">
                            Learn More
                        </a>
