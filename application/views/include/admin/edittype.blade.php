<ol class="breadcrumb breadcrumb-bg-grey">
    ...
    <li class="active"><a href="javascript:void(0);">Sửa loại</a></li>
</ol>
                    ...
                    <form method="POST" action="" id="form-dang-tin">
                        <div class="col-md-3">
                            <div class="form-group form-float">
                                ...
                                <div class="form-line">
                                    <input type="text" name='name_vi' class="form-control" required="" aria-required="true" value="{{$tin['name_vi']}}">
                        ...
                        <div class="col-md-3">
                            <div class="form-group form-float">
                                ...
                                <div class="form-line">
                                    <input type="text" name='name_en' class="form-control" aria-required="true" value="{{$tin['name_en']}}">
                                    <label class="form-label"></label>
                                </div>
                            </div>
                        </div>
