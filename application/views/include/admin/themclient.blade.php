                    ...
                    <form method="POST" action="" id="form-dang-tin" class="col-md-12">
                        ...
                        <div class='col-md-5'>
                            <div class="form-group form-float">
                                <b class="form-label">Tên đối tác</b>
                                <div class="form-line">
                                    <input type="text" name='name_client' class="form-control" required="" aria-required="true">
                        ...
                        <div class='col-md-5'>
                            <div class="form-group form-float">
                                <b class="form-label">Liên kết:</b>
                                <div class="form-line">
                                    <input type="text" name='link' class="form-control" aria-required="true">
                                    <label class="form-label"></label>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12" style="padding-left:0;">
                            <button type="submit" name="dangtin" class="btn btn-primary">Thêm đối tác</button>
                        </div>
                    </form>
                </div>
            </div>
